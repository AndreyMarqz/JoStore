...
export function HomePage({
  ...
  function scrollToCollection() {
    document
      .querySelector(".product-sections")
  ...
  return (
    <>
      <section
        ...
        aria-label="Destaque principal da loja"
      >
        <div className="hero-slide slide-one">
          <img
            src={heroImage}
            alt="Coleção em destaque da JoStore"
      ...
      <div className="product-sections">
        {productsError ? (
          <p className="product-sections-notice">{productsError}</p>
        ) : null}
